...
class Graphs_covid19:
    ...
    def covid19cases_by_country(self,country,min_total_cases):
    ...
    def graph_cases_by_country(self,country,min_total_cases):
        df = self.covid19cases_by_country(country,min_total_cases)
    ...
    def graph_bar_cases_by_country(self,country1,country2,country3,country4,country5,min_total_cases):
        df1 = self.covid19cases_by_country(country1,min_total_cases)
        ...
        df2 = self.covid19cases_by_country(country2,min_total_cases)
        ...
        df3 = self.covid19cases_by_country(country3,min_total_cases)
        ...
        df4 = self.covid19cases_by_country(country4,min_total_cases)
        ...
        df5 = self.covid19cases_by_country(country5,min_total_cases)
    ...
    #graph total cases various contries
    def graph_bar_deaths_by_country(self,country1,country2,country3,country4,country5,min_total_cases):
        df1 = self.covid19cases_by_country(country1,min_total_cases)
    ...
    #graph cases and total_cases vs date
    def graph_deaths_by_country(self,country,min_total_cases):
        df = self.covid19cases_by_country(country,min_total_cases)
        ...
        plt.tight_layout()
        return plt.show()
    #First graft of code - useless and to be erased
    def graph(self,objective,minc,date,limitdays):
...
graph = Graphs_covid19()
graph.graph_bar_cases_by_country("Spain","Italy", "China","United_States_of_America","Mexico",100)

graph.graph_bar_deaths_by_country("Spain","Italy", "China","United_States_of_America","Mexico",100)
#exit()
for country in countries:
    graph.graph_cases_by_country(country,from_minimal_cases)


for country in countries:
    graph.graph_deaths_by_country(country,from_minimal_cases)
